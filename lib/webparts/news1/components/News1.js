...
var News1 = /** @class */ (function (_super) {
    __extends(News1, _super);
    function News1() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    News1.prototype.render = function () {
        ...
        return (React.createElement("section", { className: "".concat(styles.news1, " ").concat(hasTeamsContext ? styles.teams : '') },
